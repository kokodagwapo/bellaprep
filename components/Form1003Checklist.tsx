...
import { getRequirements, Requirement } from '../data/requirements'; // Using the same logic for now
...
const RequirementItem: React.FC<{ requirement: Requirement; isCompleted: boolean }> = ({ requirement, isCompleted }) => (
    <div className="flex items-start space-x-3">
        ...
        <div>
            ...
            {/* Can add description here if needed */}
        </div>
    </div>
);


const Form1003Checklist: React.FC<Form1003ChecklistProps> = ({ loanPurpose, formData }) => {
  ...
  return (
    <div className="space-y-4 p-6 bg-secondary/50 rounded-lg border border-border">
      <h3 className="text-lg font-bold font-heading text-foreground">Application Checklist</h3>
