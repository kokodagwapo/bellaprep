  ...
  return (
    <div className="text-center flex flex-col justify-center items-center relative w-full" style={{minHeight: '400px', pointerEvents: 'auto', visibility: 'visible', opacity: 1, zIndex: 10, position: 'relative'}}>
      <div className="px-2 w-full">
        ...
        <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-light mb-4 sm:mb-5 px-2" style={{ color: '#6b7280' }}>Discover Mortgage Possibilities</p>
        <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed font-light mb-6 sm:mb-8 px-2" style={{ color: '#6b7280' }}>Our streamlined pre-evaluation process guides you step by step through your loan application. We'll help you gather the right information, verify your documents, and prepare a complete file that's ready for lender review.</p>
      </div>
