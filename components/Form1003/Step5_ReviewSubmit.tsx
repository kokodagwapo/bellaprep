            ...
            <div className="mt-10">
                <div className="flex flex-col sm:flex-row-reverse gap-4">
                    <button
                        ...
                        className="w-full flex-1 bg-primary text-primary-foreground font-bold py-3 px-6 rounded-lg sm:rounded-xl hover:bg-primary/90 transition duration-300 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring shadow-lg hover:shadow-xl text-sm sm:text-base"
                    >
                        Submit Application
                    </button>
                    <button
                        onClick={onBack}
                        className="w-full flex-1 text-primary-foreground font-medium py-3 px-6 rounded-lg bg-primary hover:bg-primary/90 transition duration-300 inline-flex items-center justify-center shadow-sm hover:shadow-md"
                    >
